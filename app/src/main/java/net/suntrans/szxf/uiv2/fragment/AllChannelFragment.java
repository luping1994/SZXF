...
import net.suntrans.szxf.databinding.FragmentAllChannelBinding;
import net.suntrans.szxf.rx.BaseSubscriber;
import net.suntrans.szxf.uiv2.bean.ChannelEntity;
import net.suntrans.szxf.uiv2.bean.ChannelInfo;
import net.suntrans.szxf.uiv2.widget.FullScreenDialog;
...
//        BottomSheetDialog dialog = new BottomSheetDialog(getContext());
    ...
    private void getData() {
        ...
        mCompositeSubscription.add(api.getScebeChooseChannel()
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new BaseSubscriber<RespondBody<List<ChannelInfo>>>(getContext()) {
                    @Override
