...
public final class Air0 implements Air {
    ...
    public void switchFengsu() {
        ...
        String id = FENG_SU.get(currentFengSuIndex)
                .get("id");
        listener.sendCmd(id);
    }
    ...
    public void switchFengXiang() {
        ...
        if (currentFengXiangIndex == FENG_XIANG.size()) {
            currentFengXiangIndex = 0;
        }
        updateUI();

        String id = FENG_XIANG.get(currentFengXiangIndex)
                .get("id");
        listener.sendCmd(id);
    }
